...
{
    public class TennisMatchInfoModel
    {
        public TennisMatchInfoModel()
        {
            this.MatchScores = new List<MatchScore>();
        }
        ...
        public TennisMatchStats MatchStats { get; set; }
        public List<MatchScore> MatchScores { get; set; }
    }

    public class TennisMatchStats
    {
